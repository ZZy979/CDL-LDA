...
def run_cdllda(name, iterations=40, update_every=8,
               n_topics_c=6, n_topics_s=6, alpha=10.0, beta=0.1,
               gamma_c=1000, gamma_s=1000, eta=0.01, seed=45):
    """训练CDL-LDA模型并预测标签。"""
    corpus = Corpus(name, r'D:\IntelliJ IDEA\projects\CDLLDA\dataset')
    model = CdlLdaModel(
...
if __name__ == '__main__':
    ...
    run_cdllda('1.comVSrec', iterations=40, update_every=8)
